            ...
            {val?.aesthetik_all_faltenunterspritzung &&
              val?.aesthetik_all_faltenunterspritzung?.map((valData, ind) => {
                ...
                return (
                  <section
                    key={ind}
                    className={`py-[20px] group bg-Bgslate ${
                      isEven
                        ? "bg-white "
                        : "bg-Bgslate reverse"
                    }`}
                  ...
                  >
                    <div
                      className={`px-4 sm:px-[50px] 3xl:px-0 py-0 3xl:py-[100px] my-[10px] md:my-[30px] 3xl:mr-[100px] relative z-10 group-[.reverse]:3xl:mr-[0] group-[.reverse]:3xl:ml-[100px] ${isEven ? '3xl:mr-[100px]' : '3xl:ml-[100px]'}  relative z-10`}
                    >
