                                        ...
                                        </div>
                                        {
                                          ContactOptionData?.footer_phone_number && 
                                           <Link href={ContactOptionData?.footer_phone_number.url}  target={ContactOptionData?.footer_phone_number.target} className="text-body lg:text-a block mt-auto">
                                              <button className='mt-auto flex self-start text-center text-base 4xl:text-a group-hover:!bg-white group-hover:!text-Teal bg-Teal text-white   font-normal  p-3 2xl:px-9 sm:py-4 transition-all duration-500 ease-in-out'>{telefonnummer_button}</button>
                                           </Link>
                                        }
                                    </div>
                                    <div className="flex flex-col active w-full md:w-[32.22%] border border-Teal gap-4 4xl:gap-6 p-4   *hover:text-white transition-all duration-500 ease-in-out">
                                       ...
                                       
                                        {
                                          ...
                                          <Link href={ContactOptionData?.footer_email_address.url} target={ContactOptionData?.footer_email_address.target} className="text-body lg:text-a block mt-auto">
                                           <button className='mt-auto flex self-start text-center text-base 4xl:text-a group-hover:!bg-white group-hover:!text-Teal bg-Teal text-white   font-normal  p-3 2xl:px-9 sm:py-4 transition-all duration-700 ease-in'>{email_button}</button>
                                          </Link>
                                        }
                                    </div>
                                    <div className="flex flex-col active w-full md:w-[32.22%] border border-Teal gap-4 4xl:gap-6 p-4  *hover:text-white transition-all duration-500 ease-in-out">
                                        ...
                                        {
                                          terminbuchung_button &&
                                          <Link href={terminbuchung_button?.url} target={terminbuchung_button?.target} className="mt-auto text-body  lg:text-a break-words  block">
                                           <button className='mt-auto flex self-start text-center text-base 4xl:text-a group-hover:!bg-white group-hover:!text-Teal bg-Teal text-white   font-normal   p-3 2xl:px-9 sm:py-4 transition-all duration-700 ease-in'>{terminbuchung_button?.title}</button>
                                          </Link>
                                        }
                                    </div>
                            </div>
