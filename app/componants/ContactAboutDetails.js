  ...
  return (
         <section className="py-10 md:py-[70px]  lg:py-[100px]">
           <div className=" flex flex-col gap-8">
                <div className="flex relative w-full max-w-[1578px] px-[15px] gap-4 sm:gap-8  flex-col pb-4 lg:pb-[25px] mx-auto text-center justify-center after:absolute after:bottom-0 after:w-20 after:left-1/2 after:h-[1px] after:bg-black-800">
                 <h2>{main_title}</h2>
                 <p dangerouslySetInnerHTML={{ __html:content?.replace(/<p>/g, '').replace(/<\/p>/g, '').replace(/&amp;/g, '&')}}></p>
                </div>
                <div className="w-full max-w-[1780px] flex flex-col lg:flex-row  gap-4 py-0 lg:py-[64px] relative after:none lg:after:absolute lg:after:right-0 lg:after:top-0 lg:after:border lg:after:border-Teal lg:after:w-[60%] lg:after:h-full lg:after:-z-10">
                        <div className="flex items-center flex-col w-full lg:w-[45%]  md:flex-row py-0 lg:py-[15px] bg-white">
                           {
                            image && 
                            <Image src={image} width={836} height={550} alt="about-left.png" className="w-full object-cover h-full"/>
                           }
                        </div>
                        <div className="flex gap-5  flex-col w-full justify-center lg:w-[60%]    lg:gap-8 ">
                                <div className="flex flex-col sm:flex-row flex-wrap px-4  sm:px-6 md:px-8 gap-2">
