              ...
              <section className="py-10 md:py-[70px] lg:py-[105px]" key={ind} id={valData?.aesthetik_anfrage_id}>
                <div className="container px-[15px] mx-auto">
                  ...
                  >
                    ...
                    "flex items-start flex-col text-black-800 w-full sm:w-[500px]  lg:w-1/3 2xl:w-[35%] lg:flex-row  ps-6 2xl:ps-16 pb-6 2xl:pb-16 relative after:absolute after:left-0  after:top-12 after:border after:border-Teal after:w-[calc(100%-24px)] 2xl:after:w-[calc(100%-48px)] after:h-[calc(100%-48px)] after:-z-10"
                    :
                    "flex items-start flex-col w-full sm:w-[500px]  lg:w-1/3 2xl:w-[35%] lg:flex-row  pe-8 pb-8 2xl:pe-16 2xl:pb-16 relative  after:absolute after:right-0 after:top-12 after:border after:border-Teal after:w-[calc(100%-24px)] 2xl:after:w-[calc(100%-48px)]  after:h-[calc(100%-48px)] after:-z-10"    
                    }>
