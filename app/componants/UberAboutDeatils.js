...
const UberAboutDeatils = ({main_title, content, image}) => {
  return (
      ...
      <section className="pb-[30px] md:pb-[70px] md:pt-0 pt-[30px] lg:pb-[100px] bg-Bgslate">
        <div className="w-full max-w-[1780px] px-[15px] lg:px-0">
          ...
          <div className="flex items-center flex-col w-full lg:w-[50%] md:flex-row">
              {image && 
                 <Image src={image} width={908} height={804} alt="about-left.png" className="w-full object-contain lg:object-cover h-full relative z-[1]"/>
              }
          </div>
