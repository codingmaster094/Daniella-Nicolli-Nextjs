  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
          ...
          'Category-bg':"linear-gradient(rgba(33, 30, 28, 0.302) 0%, rgba(33, 30, 28, 0.302) 100%),url('/images/bg-flower.jpg')",
          'slider-image': "linear-gradient(180deg, rgba(0, 0, 0, 0.085) 0%, rgba(0, 0, 0, 0.85) 100%),url('/images/bg-slider.jpg')",
